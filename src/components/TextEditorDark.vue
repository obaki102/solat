    ...
    <div class="flex flex-col max-w-container bg-surat-300 bg-clip-border rounded-xl p-4">
      ...
      class="max-t-container buttons flex flex-wrap items-center gap-x-4 bg-surat-300 border border-slate-200 rounded-xl p-4 mb-2">
        <button @click="editor.chain().undo().run()" :disabled="!editor.can().chain().undo().run()"
          class="flexhover:scale-110 hover:bg-surat-400 p-1 rounded-lg">
          <svg xmlns="http://www.w3.org/2000/svg" class="fill-slate-100 hover:scale-110" width="20" height="20" viewBox="0 0 24 24">
            <title>undo</title>
            <path
        ...
        <button @click="editor.chain().redo().run()" :disabled="!editor.can().chain().redo().run()"
          class="flex  hover:bg-surat-400 p-1 rounded-lg">
          <svg xmlns="http://www.w3.org/2000/svg" class="fill-slate-100 hover:scale-110 " width="20" height="20" viewBox="0 0 24 24">
            <title>redo</title>
            <path
        ...
        <div class="h-6 border-l border-solid border-slate-100"></div>
        ...
        <button @click="editor.chain().toggleBold().run()" :disabled="!editor.can().chain().toggleBold().run()"
          ...
          <svg xmlns="http://www.w3.org/2000/svg" class="fill-slate-100 hover:scale-110 " 
        ...
        <button @click="editor.chain().toggleItalic().run()" :disabled="!editor.can().chain().toggleItalic().run()"
          class="flex  hover:bg-surat-400 p-1 rounded-lg" :class="{ 'bg-slate-200 rounded': editor.isActive('italic') }">
          <svg xmlns="http://www.w3.org/2000/svg" class="fill-slate-100 hover:scale-110 " width="20" height="20" viewBox="0 0 24 24">
            <title>italic</title>
        ...
        <button @click="editor.chain().toggleStrike().run()" :disabled="!editor.can().chain().toggleStrike().run()"
          class="flex  hover:bg-surat-400 p-1 rounded-lg" :class="{ 'bg-slate-200 rounded': editor.isActive('strike') }">
          <svg xmlns="http://www.w3.org/2000/svg" class="fill-slate-100 hover:scale-110 " width="20" height="20" viewBox="0 0 24 24">
            <title>strike</title>
            <path
        ...
        <button @click="editor.chain().toggleCode().run()" :disabled="!editor.can().chain().toggleCode().run()"
          class="flex  hover:bg-surat-400 p-1 rounded-lg" :class="{ 'bg-slate-200 rounded': editor.isActive('code') }">
          <svg xmlns="http://www.w3.org/2000/svg" class="fill-slate-100 hover:scale-110 " width="20" height="20" viewBox="0 0 24 24">
            <title>code</title>
            <path
        ...
        <button @click="editor.chain().toggleHeading({ level: 1 }).run()" class="flex  hover:bg-surat-400 p-1 rounded-lg"
        ...
        <button @click="editor.chain().toggleHeading({ level: 2 }).run()" class="flex  hover:bg-surat-400 p-1 rounded-lg"
        ...
        <button @click="editor.chain().toggleHeading({ level: 3 }).run()"  class="flex  hover:bg-surat-400 p-1 rounded-lg"
        ...
        <button @click="editor.chain().toggleBulletList().run()" class="flex  hover:bg-surat-400 p-1 rounded-lg"
        ...
        <button @click="editor.chain().toggleOrderedList().run()" class="flex  hover:bg-surat-400 p-1 rounded-lg"
        ...
        <button @click="editor.chain().toggleCodeBlock().run()" class="flex  hover:bg-surat-400 p-1 rounded-lg"
        ...
        <button @click="editor.chain().toggleBlockquote().run()" class="flex  hover:bg-surat-400 p-1 rounded-lg"
        ...
        <button @click="editor.chain().setHorizontalRule().run()" class="flex  hover:bg-surat-400 p-1 rounded-lg">
          <svg xmlns="http://www.w3.org/2000/svg" class="fill-slate-100 hover:scale-110 " width="20" height="20" viewBox="0 0 24 24">
            <title> horizontal rule</title>
            <path d="M21 11H3V9H21V11M21 13H3V15H21V13Z" />
          </svg>
        </button>
        <button @click="editor.chain().setHardBreak().run()" class="flex  hover:bg-surat-400 p-1 rounded-lg">
          <svg xmlns="http://www.w3.org/2000/svg" class="fill-slate-100 hover:scale-110 " width="20" height="20" viewBox="0 0 24 24">
