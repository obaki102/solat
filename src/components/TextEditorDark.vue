    ...
    <div class="flex flex-col max-w-container bg-surat-300 bg-clip-border p-4">
      <div v-if="editor"
        ...
        <button @click="editor.chain().undo().run()" :disabled="!editor.can().chain().undo().run()"
          ...
          <svg xmlns="http://www.w3.org/2000/svg" class="fill-slate-100 hover:scale-110" width="20" height="20"
            viewBox="0 0 24 24">
            <title>undo</title>
            <path
        ...
        <button @click="editor.chain().toggleBold().run()" :disabled="!editor.can().chain().toggleBold().run()"
          class="flex  hover:bg-surat-400 p-1 rounded-lg" :class="{ 'bg-surat-500 rounded ': editor.isActive('bold') }">
          <svg xmlns="http://www.w3.org/2000/svg" class="fill-slate-100 hover:scale-110" width="20" height="20"
            viewBox="0 0 24 24">
            <title>bold</title>
            <path
        ...
        <button @click="editor.chain().toggleItalic().run()" :disabled="!editor.can().chain().toggleItalic().run()"
          class="flex  hover:bg-surat-400 p-1 rounded-lg"
          :class="{ 'bg-surat-500 rounded': editor.isActive('italic') }">
          <svg xmlns="http://www.w3.org/2000/svg" class="fill-slate-100 hover:scale-110" width="20" height="20"
            viewBox="0 0 24 24">
            <title>italic</title>
        ...
        <button @click="editor.chain().toggleStrike().run()" :disabled="!editor.can().chain().toggleStrike().run()"
          class="flex  hover:bg-surat-400 p-1 rounded-lg"
          :class="{ 'bg-surat-500 rounded': editor.isActive('strike') }">
          <svg xmlns="http://www.w3.org/2000/svg" class="fill-slate-100 hover:scale-110" width="20" height="20"
            viewBox="0 0 24 24">
            <title>strike</title>
            <path
        ...
        <button @click="editor.chain().toggleCode().run()" :disabled="!editor.can().chain().toggleCode().run()"
          class="flex  hover:bg-surat-400 p-1 rounded-lg" :class="{ 'bg-surat-500 rounded': editor.isActive('code') }">
          <svg xmlns="http://www.w3.org/2000/svg" class="fill-slate-100 hover:scale-110" width="20" height="20"
            viewBox="0 0 24 24">
            <title>code</title>
            <path
        ...
        <button @click="editor.chain().toggleHeading({ level: 1 }).run()"
          class="flex  hover:bg-surat-400 p-1 rounded-lg"
          :class="{ 'bg-surat-500 rounded': editor.isActive('heading', { level: 1 }) }">
          <svg xmlns="http://www.w3.org/2000/svg" class="fill-slate-100 hover:scale-110" width="20" height="20"
            viewBox="0 0 24 24">
            <title>H1</title>
        ...
        <button @click="editor.chain().toggleHeading({ level: 2 }).run()"
          class="flex  hover:bg-surat-400 p-1 rounded-lg"
          :class="{ 'bg-surat-500 rounded': editor.isActive('heading', { level: 2 }) }">
          <svg xmlns="http://www.w3.org/2000/svg" class="fill-slate-100 hover:scale-110" width="20" height="20"
            viewBox="0 0 24 24">
            <title>H2</title>
            <path
        ...
        <button @click="editor.chain().toggleHeading({ level: 3 }).run()"
          class="flex  hover:bg-surat-400 p-1 rounded-lg"
          :class="{ 'bg-surat-500 rounded': editor.isActive('heading', { level: 3 }) }">
          <svg xmlns="http://www.w3.org/2000/svg" class="fill-slate-100 hover:scale-110" width="20" height="20"
            viewBox="0 0 24 24">
            <title>H3</title>
            <path
        ...
        <button @click="editor.chain().toggleBulletList().run()" class="flex  hover:bg-surat-400 p-1 rounded-lg"
          :class="{ 'bg-surat-500 rounded': editor.isActive('bulletList') }">
          <svg xmlns="http://www.w3.org/2000/svg" class="fill-slate-100 hover:scale-110" width="20" height="20"
            viewBox="0 0 24 24">
        ...
        <button @click="editor.chain().toggleOrderedList().run()" class="flex  hover:bg-surat-400 p-1 rounded-lg"
          :class="{ 'bg-surat-500 rounded': editor.isActive('orderedList') }">
          <svg xmlns="http://www.w3.org/2000/svg" class="fill-slate-100 hover:scale-110" width="20" height="20"
            viewBox="0 0 24 24">
        ...
        <button @click="editor.chain().toggleCodeBlock().run()" class="flex  hover:bg-surat-400 p-1 rounded-lg"
          :class="{ 'bg-surat-500 rounded': editor.isActive('codeBlock') }">
          <svg xmlns="http://www.w3.org/2000/svg" class="fill-slate-100 hover:scale-110" width="20" height="20"
            viewBox="0 0 24 24">
        ...
        <button @click="editor.chain().toggleBlockquote().run()" class="flex  hover:bg-surat-400 p-1 rounded-lg"
          :class="{ 'bg-surat-500 rounded': editor.isActive('blockquote') }">
          <svg xmlns="http://www.w3.org/2000/svg" class="fill-slate-100 hover:scale-110" width="20" height="20"
            viewBox="0 0 24 24">
