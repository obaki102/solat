<template>
  <div class="flex flex-col items-center ">
    <div v-if="editor"
      class="bg-gray-100 dark:bg-gray-900 buttons flex items-center flex-wrap gap-x-4 border-t border-l border-r border-b border-gray-800 p-4">
      ...
      <button @click="editor.chain().toggleItalic().run()" :disabled="!editor.can().chain().toggleItalic().run()"
        class="hover:bg-gray-300 p-1 rounded-lg" :class="{ 'bg-gray-300 rounded': editor.isActive('italic') }">
      ...
      <button @click="editor.chain().toggleStrike().run()" :disabled="!editor.can().chain().toggleStrike().run()"
        class="hover:bg-gray-300 p-1 rounded-lg" :class="{ 'bg-gray-300 rounded': editor.isActive('strike') }">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
          <title>strike</title>
          <path
      ...
      <button @click="editor.chain().toggleCode().run()" :disabled="!editor.can().chain().toggleCode().run()"
        class="hover:bg-gray-300 p-1 rounded-lg" :class="{ 'bg-gray-300 rounded': editor.isActive('code') }">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
          <title>code</title>
          <path
      ...
      <button @click="editor.chain().toggleHeading({ level: 1 }).run()" class="hover:bg-gray-300 p-1 rounded-lg"
      ...
      <button @click="editor.chain().toggleHeading({ level: 2 }).run()" class="hover:bg-gray-300 p-1 rounded-lg"
      ...
      <button @click="editor.chain().toggleBulletList().run()" class="hover:bg-gray-300 p-1 rounded-lg"
      ...
      <button @click="editor.chain().toggleOrderedList().run()" class="hover:bg-gray-300 p-1 rounded-lg"
      ...
      <button @click="editor.chain().toggleCodeBlock().run()" class="hover:bg-gray-300 p-1 rounded-lg"
      ...
      <button @click="editor.chain().toggleBlockquote().run()" class="hover:bg-gray-300 p-1 rounded-lg"
      ...
      <button @click="editor.chain().setHorizontalRule().run()" class="hover:bg-gray-300 p-1 rounded-lg">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
          <title> horizontal rule</title>
          <path d="M21 11H3V9H21V11M21 13H3V15H21V13Z" />
        </svg>
      </button>
      <button @click="editor.chain().setHardBreak().run()" class="hover:bg-gray-300 p-1 rounded-lg">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
    ...
    <div>
      <EditorContent :editor="editor" class="font-mono text-sm m-5 rounded-lg bg-white shadow-xl" />
    </div>
  </div>
</template>
