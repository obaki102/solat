<template>
  <div class="flex flex-col items-center">
    <div v-if="editor"
      class="buttons flex items-center flex-wrap gap-x-4 border-t border-l border-r border-b border-gray-800 p-4">
      ...
      <button @click="editor.chain().focus().toggleCode().run()"
        ...
        :class="{ 'bg-gray-300 rounded': editor.isActive('code') }">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
          <title>code</title>
          <path
